...
?>
	...
	<tr>
		...
		<td>
		<a href="delete_venue_detail.php?id=<?php echo $rows['id']; ?>" onClick="return confirm_delete()" class="btn btn-danger" role="button">Delete</a>
		</td>
	</tr>
